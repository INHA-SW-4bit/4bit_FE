            ...
            <Page>
                ...
                <Main>
                    <MainHeader>
                        ...
                        <p>4bit</p>
                        <img src={rightarrow} />
                        <p>{ (click === "attendance") ? "출석" : (click === "qna") ? "실시간 Q&A" : "none" }</p>
                    </MainHeader>
                    <Outlet />
                </Main>
            </Page>
...
const SubMenu = styled.li<{ isOpen: number, menuNum: number }>`
    ...
    background-color: ${(props) => (props.isOpen === props.menuNum) ? "#F2F3F2" : "#FFFFFF" };
    cursor: pointer;

    div {
        font-family: ${(props) => (props.isOpen === props.menuNum) ? "NanumGothicBold": "inherit"};
        font-size: 0.9rem;
    }
`
...
const ActiveSubItem = styled(SubItem)<{ click: string, menuName: string }>`
    font-family: ${(props) => (props.click === props.menuName) ? "NanumGothicBold" : "inherit" };
`
